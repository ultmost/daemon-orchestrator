...
echo ""
echo "  Next steps:"
echo "    1. Read docs/first-30-minutes.md - step-by-step setup guide"
echo "    2. Edit ~/.claude/CLAUDE.md - customize sections marked <!-- CUSTOMIZE -->"
echo "    3. Fill in ~/daemon-memory/MEMORY.md with your projects and rules"
echo "    4. Run 'claude' to start - Daemon is now active"
echo ""
